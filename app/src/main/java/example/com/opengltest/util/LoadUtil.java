...
import example.com.opengltest.object.ObjModelEnity;
...
public class LoadUtil {
	...
	public static ObjModelEnity loadFromFile
	(String fname, Resources r)
	{
		...
		ObjModelEnity objModelEnity = new ObjModelEnity();
		...
		try
		{
			...
			objModelEnity.setVertices(vXYZ);
			objModelEnity.setNormals(nXYZ);
			objModelEnity.setTexCoors(tST);
		}
		catch(Exception e)
		{
