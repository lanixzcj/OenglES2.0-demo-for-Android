...
public class BodyPart {                        //身体部件
    ...
    public BodyPart(float fx, float fy, float fz, ObjModel objModel, int index, Robot robot) {
        this.index = index;
    ...
    public void copyMatrixForDraw() {
        robot.fianlMatrixForDrawArray[index] = finalMatrix.clone();
    }
